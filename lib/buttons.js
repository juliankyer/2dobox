...
$('.none').on('click', function(e) {
  e.preventDefault();
  var matched = $('.todo-render').not(':contains("importance: none")');
  matched.toggle();
});

$('.low').on('click', function(e) {
  e.preventDefault();
  var matched = $('.todo-render').not(':contains("importance: low")');
  matched.toggle();
});

$('.normal').on('click', function(e) {
  e.preventDefault();
  var matched = $('.todo-render').not(':contains("importance: normal")');
  matched.toggle();
});

$('.high').on('click', function(e) {
  e.preventDefault();
  var matched = $('.todo-render').not(':contains("importance: high")');
  matched.toggle();
});

$('.critical').on('click', function(e) {
  e.preventDefault();
  var matched = $('.todo-render').not(':contains("importance: critical")');
  matched.toggle();
});
