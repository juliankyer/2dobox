...
$('.none').on('click', function(e) {
  e.preventDefault();
  let matched = $('span:contains("none")');
  matched.parentsUntil('.list-section').toggle();
});

$('.low').on('click', function(e) {
  e.preventDefault();
  let matched = $('span:contains("low")');
  matched.parentsUntil('.list-section').toggle();
});

$('.normal').on('click', function(e) {
  e.preventDefault();
  let matched = $('span:contains("normal")');
  matched.parentsUntil('.list-section').toggle();
});

$('.high').on('click', function(e) {
  e.preventDefault();
  let matched = $('span:contains("high")');
  matched.parentsUntil('.list-section').toggle();
});

$('.critical').on('click', function(e) {
  e.preventDefault();
  let matched = $('span:contains("critical")');
  matched.parentsUntil('.list-section').toggle();
});
